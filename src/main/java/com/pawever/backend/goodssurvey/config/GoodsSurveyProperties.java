...
public class GoodsSurveyProperties {
     ...
     * 누가 오든 같은 값이다.
     */
    private int fleaDiscountKrw = 11_000;
    ...
    // 신청 후 7일 동안 수동 입금 확인을 기다린다. yaml 기본값과 일치해야 한다.
    private int paymentWindowMinutes = 10_080;

    /**
     * 플리마켓 주문이 입금을 기다리는 시간.
     *
     * 입금 확인 지연으로 사진이 파기되지 않도록 상시 판매와 같은 7일을 쓴다.
     * 값은 환경변수로 조절할 수 있다.
     */
    private int fleaPaymentWindowMinutes = 10_080;
