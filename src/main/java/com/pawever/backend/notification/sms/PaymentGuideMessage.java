 ...
 * 않는다. 넣으면 오히려 거짓이 된다.
 *
 * 항목 앞의 ■ 는 EUC-KR 에 있는 글자여야 한다. 국내 LMS 는 EUC-KR 로 실려
 * 가고, 거기 없는 글자는 받는 폰에서 물음표가 되거나 사라진다. 계좌 안내
 * 한가운데가 깨지면 낼 방법을 잃는다. 확정본의 ◼︎ 가 그런 글자였다.
 */
public final class PaymentGuideMessage {
     ...
     *
     * <p>설정은 분으로 들어온다. 그대로 적으면 "2880분 안에"가 되는데, 받는
     * 사람은 그게 언제까지인지 계산해야 한다. 계산하게 만드는 안내는 안내가
     * 아니다.
     *
     * <p>하루가 넘어도 일로 접지 않는다. 하루짜리 행사에서 "1일 안에"는 오늘
     * 자정까지인지 내일 이맘때까지인지 되짚어야 하는 말이고, "24시간 안에"는
     * 그대로 읽힌다.
     */
